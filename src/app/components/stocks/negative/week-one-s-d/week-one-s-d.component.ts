...
@Component({
  selector: 'app-week-one-s-d',
  templateUrl: './week-one-s-d.component.html',
  styleUrls: ['./week-one-s-d.component.scss'],
})
export class WeekOneSDComponent implements OnInit {

...
@Component({
  selector: 'app-s-p-three-month',
  templateUrl: './s-p-three-month.component.html',
  styleUrls: ['./s-p-three-month.component.scss'],
})
export class SPThreeMonthComponent implements OnInit {

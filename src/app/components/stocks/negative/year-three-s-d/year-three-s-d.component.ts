...
@Component({
  selector: 'app-year-three-s-d',
  templateUrl: './year-three-s-d.component.html',
  styleUrls: ['./year-three-s-d.component.scss'],
})
export class YearThreeSDComponent implements OnInit {

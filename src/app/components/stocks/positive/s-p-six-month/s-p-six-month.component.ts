...
@Component({
  selector: 'app-s-p-six-month',
  templateUrl: './s-p-six-month.component.html',
  styleUrls: ['./s-p-six-month.component.scss'],
})
export class SPSixMonthComponent implements OnInit {

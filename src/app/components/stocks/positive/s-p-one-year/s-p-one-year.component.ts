...
@Component({
  selector: 'app-s-p-one-year',
  templateUrl: './s-p-one-year.component.html',
  styleUrls: ['./s-p-one-year.component.scss'],
})
export class SPOneYearComponent implements OnInit {

...
@Component({
  selector: 'app-c-n-one-week',
  templateUrl: './c-n-one-week.component.html',
  styleUrls: ['./c-n-one-week.component.scss'],
})
export class CNOneWeekComponent implements OnInit {

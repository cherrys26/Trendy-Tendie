...
@Component({
  selector: 'app-s-p-three-year',
  templateUrl: './s-p-three-year.component.html',
  styleUrls: ['./s-p-three-year.component.scss'],
})
export class SPThreeYearComponent implements OnInit {

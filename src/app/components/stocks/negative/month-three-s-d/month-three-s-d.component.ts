...
@Component({
  selector: 'app-month-three-s-d',
  templateUrl: './month-three-s-d.component.html',
  styleUrls: ['./month-three-s-d.component.scss'],
})
export class MonthThreeSDComponent implements OnInit {

...
@Component({
  selector: 'app-s-p-one-month',
  templateUrl: './s-p-one-month.component.html',
  styleUrls: ['./s-p-one-month.component.scss'],
})
export class SPOneMonthComponent implements OnInit {
